...
namespace Vfx
{
    ...
    public sealed class PlayerDustEffects : MonoBehaviour
    {
        ...
        [SerializeField] private Color dustColor = new Color(0.86f, 0.78f, 0.62f, 0.9f);
        ...
        private void LateUpdate()
        {
            ...
            _emission.rateOverTime = grounded && moving ? 26f : 0f;
        ...
        private void BuildParticleSystem()
        {
            ...
            gradient.SetKeys(
                ...
                new[] { new GradientAlphaKey(0f, 0f), new GradientAlphaKey(dustColor.a, 0.12f), new GradientAlphaKey(0f, 1f) });
            colorOverLifetime.color = gradient;

            var sizeOverLifetime = _particles.sizeOverLifetime;
            sizeOverLifetime.enabled = true;
            sizeOverLifetime.size = new ParticleSystem.MinMaxCurve(1f,
                AnimationCurve.EaseInOut(0f, 0.7f, 1f, 2.1f));
